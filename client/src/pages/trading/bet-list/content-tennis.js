...
const defaultListGTAHOU = ['ML', 'AHSW', 'GAH', 'OUGOU', 'OEGOE']
          ...
          <Col span={8}>
            ...
            >
              ...
              <Form.Item name="list_gt" wrapperCol={24}>
                <Checkbox.Group>
                  <Checkbox value={defaultListGTAHOU[0]}>All ML</Checkbox>
                  <Checkbox value={defaultListGTAHOU[1]}>All AH/SW</Checkbox>
                  <Checkbox value={defaultListGTAHOU[2]}>All G.AH</Checkbox>
                  <Checkbox value={defaultListGTAHOU[3]}>All OU/G.OU</Checkbox>
                  <Checkbox value={defaultListGTAHOU[4]}>All OE/G.OE</Checkbox>
                </Checkbox.Group>
              </Form.Item>
              <Space>
                <Button
