...
const choiceTitleList = ['FG.H', 'FG.A', 'LG.H', 'LG.A', 'NO GOAL']
const choiceList = ['FG1', 'FG2', 'LG1', 'LG2', 'NOG']

const TableDeadballFGLG = React.memo(
  React.forwardRef(({ refetch, ...restProps }, ref) => {
    ...
    const columns = React.useMemo(
      () => [
        ...
        ...choiceTitleList.map((title, index) => ({
          title,
          width: 100,
...
export default TableDeadballFGLG
