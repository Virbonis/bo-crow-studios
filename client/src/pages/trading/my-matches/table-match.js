...
//
const mapStateToProps = ({ myMatches }, ownProps) => ({
  loading: myMatches[`loadingData_${ownProps.match_time_slot}`],
  data: myMatches[`data_${ownProps.match_time_slot}`] || [],
})
...
const TableMatch = ({
  ...
  }, [expanded, match_time_slot, LoadMatches, CleanExtraTable])
