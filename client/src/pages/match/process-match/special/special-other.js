...
import { Form, Checkbox, Select, Row, InputNumber, message, Spin, Table, Space } from 'antd'
...
const TableFormSpecial = ({ data, form }) => {
  ...
  const columns = [
    ...
    {
      title: <Checkbox onChange={onCheckAllGameType}>Process</Checkbox>,
      width: 300,
...
export default connect(mapStateToProps, mapDispatchToProps)(ProcessSpecialOther)
